...
func (p *Spos) delayForRamanujanFork(snap *Snapshot, header *types.Header) time.Duration {
...
func (p *Spos) blockTimeForRamanujanFork(snap *Snapshot, header, parent *types.Header) uint64 {
...
func (p *Spos) blockTimeVerifyForRamanujanFork(snap *Snapshot, header, parent *types.Header) error {
	if p.chainConfig.IsRamanujan(header.Number) {
